...
var usersRepo = repositories_1.usersRepository();
...
var userByName = {
    ...
    resolve: function (root, args) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, usersRepo.getUserByName(args.name)];
...
var users = {
    ...
    resolve: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, usersRepo.getUsers()];
            case 1: return [2, _a.sent()];
        }
    }); }); },
};
